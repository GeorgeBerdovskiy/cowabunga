...
fp = open("tests/generated_scripts/correctness_m2.log.py", "w")
...
# Now close the database... and do another `NUM_INSERTIONS` random queries!
db.close()
db.open("./CORRECTNESS_M2")
...
print(f"[INFO] Success! Ran _another_ {NUM_INSERTIONS} random queries without errors or mismatches in behavior.")
